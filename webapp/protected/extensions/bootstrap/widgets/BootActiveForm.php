...
Yii::import('ext.bootstrap.widgets.input.BootInput');
...
class BootActiveForm extends CActiveForm
{
	...
	// Input classes.
	const INPUT_HORIZONTAL = 'ext.bootstrap.widgets.input.BootInputHorizontal';
	const INPUT_INLINE = 'ext.bootstrap.widgets.input.BootInputInline';
	const INPUT_SEARCH = 'ext.bootstrap.widgets.input.BootInputSearch';
	const INPUT_VERTICAL = 'ext.bootstrap.widgets.input.BootInputVertical';
